                      ...
                      <div class="modal-content">
                        ...
                        <form>
                          <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="text" aria-describedby="emailHelp" placeholder="Family List"/>
                          </div>
                          <div class="mb-3">
                            <label for="exampleInputPassword1" class="form-label">Owners</label>
                            <input type="email" class="form-control" id="email" placeholder="yourfriendemail@gmail.com"/>
                            <div id="emailHelp" class="form-text">Do you want to share the list with someone else? Enter the email.</div>
                          </div>
                        </form>
                        </div>
