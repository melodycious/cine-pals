        ...
        <div className="tab-content" id="pills-tabContent">
          ...
          >
            <div className="container-fluid">
              ...
              <div className="row">
                {store.pelis.map((pelicula, index) => (
                    ...
                    <div className="card-body">
                      ...
                      <div className="form_check">
                        <div className="container_button">
                          <button
                            onClick={() => restar(pelicula)}
                            className="contador"
                          >
                            -
                          </button>
                          <button
                            onClick={() => sumar(pelicula)}
                            className="contador"
                          >
                            +
                          </button>
                        ...
                        <span
                          className={`animate__animated ${
                            animationTriggers[pelicula] ? "animate__bounce" : ""
                          }`}
                        >
                          {contadores[pelicula] || 0}{" "}
